...
1. Add an AngularJS front-end
   ...
   1. [Have page wait for REST calls to resolve](/learnAngularJS/lessons/lesson08b_setupGridDataWithResolve.txt)
   ...
   1. [Add a Lookup Factory](/learnAngularJS/lessons/lesson10_setupGridWithLookupFactory.txt)
