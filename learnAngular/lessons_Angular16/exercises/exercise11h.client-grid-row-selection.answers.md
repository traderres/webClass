```
Exercise 11h / Client Grid / Row Selection  (Answers)
-----------------------------------------------------
        ...
        <div class="m-2.5">
         ...
         <!-- Top of Page -->
          <div class="grid grid-cols-2">
              <div>
                <span class="text-xl">Grid Page with Row Selection</span>
              </div>
...
----------------------------------------------------------------------------------
 1. Create a frontend DTO:  GridCellDataForRowSelectionDTO
        ...
        export class GridCellDataForRowSelectionDTO {
          public id:                     number;
          public full_name:              string;
          public csv_roles:              string;
     ...
     c. Fill-in this public method
        ...
        4) Return the observable
          ...
          public getAllUsers(): Observable<GridCellDataForRowSelectionDTO[]> {
            let data: GridCellDataForRowSelectionDTO[] = [
              {
                id: 101,
                full_name: 'Adam Smith',
                csv_roles: 'USER, ADMINISTRATOR',
                account_created_date: '11/09/2023',
                last_login_date:   '09/05/2024'
              },
              {
                id: 102,
                full_name: 'Ben Smith',
                csv_roles: 'USER',
                account_created_date: '04/01/2022',
                last_login_date:   '05/02/2023'
              },
              {
                id: 103,
                full_name: 'Justin Resnick',
                csv_roles: 'USER',
                account_created_date: '02/02/2023',
                last_login_date:   '01/05/2024'
              },
            ];
...
<div class="bg-backDropColor m-2.5">
  ...
  <div class="flex flex-row w-full bg-white rounded-tr h-10 flex-shrink-0 items-center border-x border-t border-borderColor px-3">
    ...
    <!-- Pop-up menu for the 'Settings' button -->
    <mat-menu #gridMenu="matMenu">
      <button mat-menu-item type="button" (click)="this.resetGrid()"  title="Reset Grid" aria-label="Reset Grid">
        Reset Grid
      </button>
    </mat-menu>
