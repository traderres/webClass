Lesson 30d: Tab Group Page / Add "All Reports" Grid to Tab
----------------------------------------------------------
The Google Drive link is here:<br>
&nbsp;&nbsp;&nbsp;https://docs.google.com/document/d/160fV2fRzGdoDFAGFuOf4BciZOi6ofwQS3ato8DN37lM/edit?usp=sharing
      

The source code for this lesson is here:<br>
&nbsp;&nbsp;&nbsp;https://github.com/traderres/angularApp1Lessons/tree/lesson30d/tab-group/add-all-reports-grid
<br>
<br>
<br>
...
Procedure
---------
    1. Add a REST call that limits returns all reports
       a. Edit GridController.java

       b. Add this public method   (acts as the REST endpoint used by the server-side ag-grid)
    ...
    3. Create a small component (that holds the "Critical Reports" server side grid and buttons)
       a. Generate the component
          ...
          unix> ng generate component analytics/grid-tab-group/all-reports-grid --skipTests

       b. Edit all-reports-grid.component.ts
       ...
       c. Edit all-reports-grid.component.html
       ...
       d. Edit all-reports-grid.component.css
          ...
          To this:
            ...
            <mat-tab label="All Reports">
                    <div class="tab-content">
                        ...
                        <!-- All Reports Grid -->
                        <app-all-reports-grid></app-all-reports-grid>
                 
                    </div>
            </mat-tab>


    5. Verify that the "All Reports" grid looks good
       a. Activate the debugger on "Full WebApp"
       b. Click on "All Reports" on the left-side navbar
